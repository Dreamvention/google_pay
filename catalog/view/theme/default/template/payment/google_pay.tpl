<div id="form_google_pay" class="form-horizontal">
	<div class="buttons">
		<div id="google_pay_button_container" class="pull-right"></div>
	</div>
</div>
...
function addGooglePayButton() {
    ...
    document.getElementById('google_pay_button_container').appendChild(button);
}
...
function onGooglePaymentButtonClicked() {
    ...
    paymentsClient.loadPaymentData(paymentDataRequest).then(function(paymentData) {
        console.log('Payment Data, send to gateway');
...
function showAlert(json) {
	...
	if (json['error']) {
		if (json['error']['warning']) {
			$('#form_google_pay').prepend('<div class="alert alert-danger"><i class="fa fa-exclamation-circle"></i><button type="button" class="close" data-dismiss="alert">&times;</button> ' + json['error']['warning'] + '</div>');
		}
	}
}
